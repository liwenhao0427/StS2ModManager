...
public partial class LocalizationService : ObservableObject
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _texts = new(StringComparer.OrdinalIgnoreCase)
    {
        [LanguageZhCn] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Mods.RenameByFolder"] = "用目录名称更新",
            ["Mods.BatchRenameByFolder"] = "按目录名批量更新",
            ...
            ["Status.ModNameUpdatedByFolder"] = "已用目录名称更新当前Mod名称",
            ["Status.ModNameBatchUpdatedByFolder"] = "已批量按目录名更新 {0} 个Mod",
            ...
            ["Msg.NoModForDirectoryRename"] = "当前没有可按目录名处理的Mod。",
            ["Msg.DirectoryRenameSourceRequired"] = "请至少勾选一个要处理的目录。",
            ["Msg.DirectoryRenameDone"] = "已按目录名称更新 {0} 个Mod。",
            ...
            ["Dialog.RenameByFolder.Title"] = "选择要按目录名更新的目录",
            ["Dialog.RenameByFolder.Header"] = "请选择要处理的目录",
            ["Dialog.RenameByFolder.Hint"] = "会把所选目录下的 Mod 名称替换为各自目录名称。",
        ...
        [LanguageEnUs] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Mods.RenameByFolder"] = "Use Folder Name",
            ["Mods.BatchRenameByFolder"] = "Batch Use Folder Names",
            ...
            ["Status.ModNameUpdatedByFolder"] = "Updated current mod name from folder name",
            ["Status.ModNameBatchUpdatedByFolder"] = "Updated {0} mod names from folder names",
            ...
            ["Msg.NoModForDirectoryRename"] = "There are no mods available for folder-name renaming.",
            ["Msg.DirectoryRenameSourceRequired"] = "Please select at least one directory to process.",
            ["Msg.DirectoryRenameDone"] = "Updated {0} mods with their folder names.",
            ...
            ["Dialog.RenameByFolder.Title"] = "Select Directories to Rename by Folder",
            ["Dialog.RenameByFolder.Header"] = "Choose directories to process",
            ["Dialog.RenameByFolder.Hint"] = "Mod names under selected directories will be replaced with their folder names.",
